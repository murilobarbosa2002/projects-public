						...
						<div class="col-sm-10 col-sm-offset-1">
							<div class="login-container">
                                ...
                                <br>
                                    <br>
                                <br>
								<div class="center"> <img src="<?php echo URL_SITE ?>uploads/images/configuracoes/logo-interna.png" alt="Seu Logo" style="--width: 326;--height: 45;"> </div>
...
<?php }else{
	...
	<html lang="pt-br">
		<head>
			<meta charset="utf-8" />
			<title>GV8 Painel</title>
			<meta name="viewport" content="width=device-width, initial-scale=1.0" />
			<link rel="stylesheet" href="<?=URL_PAINEL_TEMPLATE?>assets/css/ace-fonts.min.css" />
			<link href="<?=URL_PAINEL_TEMPLATE?>assets/css/bootstrap.min.css" rel="stylesheet" />
			<link rel="stylesheet" href="<?=URL_PAINEL_TEMPLATE?>assets/css/font-awesome.min.css" />
			<!--[if IE 7]> <link rel="stylesheet" href="<?=URL_PAINEL_TEMPLATE?>assets/css/font-awesome-ie7.min.css" /> <![endif]-->
            <link rel="shortcut icon" type="image/x-icon" href="<?php echo URL_SITE ?>uploads/images/configuracoes/1412947591favicon.png" />
			<link rel="stylesheet" href="<?=URL_PAINEL_TEMPLATE?>assets/css/ace.min.css" />
			<link rel="stylesheet" href="<?=URL_PAINEL_TEMPLATE?>assets/css/ace-rtl.min.css" />
		...
		<body>
			<div class="navbar navbar-default" id="navbar">
				<div class="navbar-container" id="navbar-container">
					<div class="navbar-header pull-left"><a href="<?=URL_PAINEL?>inicial" class="navbar-brand"><img src="<?php echo URL_SITE ?>uploads/images/configuracoes/logo-interna.png" alt="Seu Logo" style="--width: 326;--height: 45;"></a></div>
				...
				<div class="main-container-inner">
					...
					<div class="sidebar" id="sidebar">
						<ul class="nav nav-list">
                            ...
                            $Administradores->criar_menu_painel_item('Administração',true,$sistemas,array(1,2));  ?>

                            <?php $sistemas = array('url' => 'configuracoes', 'nome' => 'Configurações do site', 'page' => false );
                            $Administradores->criar_menu_painel_item('Configurações',false,$sistemas,array(1,2,3)); ?>

							<?php $sistemas = array();
							$sistemas[] = array('url' => 'banners', 'nome' => 'Banners', 'page' => false );
                            $sistemas[] = array('url' => 'texto-1-home', 'nome' => 'Texto 1', 'page' => true );
                            $sistemas[] = array('url' => 'texto-2-home', 'nome' => 'Texto 2', 'page' => true );
                            $sistemas[] = array('url' => 'texto-3-home', 'nome' => 'Texto 3', 'page' => true );
                            $sistemas[] = array('url' => 'titulo-categorias', 'nome' => 'Título de Categorias', 'page' => true );
                            $sistemas[] = array('url' => 'titulo-newsletter', 'nome' => 'Texto Newsletter', 'page' => true );
                            $sistemas[] = array('url' => 'titulo-arquivos', 'nome' => 'Título Arquivos', 'page' => true );
                            $sistemas[] = array('url' => 'publicidade', 'nome' => 'Publicidade', 'page' => true );
							$Administradores->criar_menu_painel_item('Home',true,$sistemas,array(1,2,3)); ?>

                            <?php  $sistemas = array();
                            $sistemas[] = array('url' => 'empresa', 'nome' => 'Textos', 'page' => true );
                            $Administradores->criar_menu_painel_item('Empresa',true,$sistemas,array(1,2,3)); ?>

                            <?php  $sistemas = array();
                            $sistemas[] = array('url' => 'cadastrar-categoria', 'nome' => 'Categorias', 'page' => false );
                            $sistemas[] = array('url' => 'noticias', 'nome' => 'Notícias', 'page' => false );
                            $Administradores->criar_menu_painel_item('Categoria',true,$sistemas,array(1,2,3)); ?>

                            <?php  $sistemas = array();
                            $sistemas[] = array('url' => 'contato', 'nome' => 'Textos', 'page' => true );
                            $Administradores->criar_menu_painel_item('Contato',true,$sistemas,array(1,2,3)); ?>

                            <?php  $sistemas = array();
                            $sistemas[] = array('url' => 'contatos', 'nome' => 'Formulário de Contato', 'page' => false );
                            $sistemas[] = array('url' => 'newsletters', 'nome' => 'Newsletter', 'page' => false );
                            $Administradores->criar_menu_painel_item('E-mails Recebidos',true,$sistemas,array(1,2,3)); ?>
