...
if (!isset($url[1])||$url[1]=='page') {
    if (!empty($_POST)) {
        ...
        if (isset($_POST['busca'])||isset($_POST['cidade'])||isset($_POST['estado'])) { 
            ...
            $_SESSION['cidade_'.$sistema['bd']] = $_POST['cidade'];
            $_SESSION['estado_'.$sistema['bd']] = $_POST['estado'];
        } 
                                            ...
                                            <?php foreach ($sistema['list'] as $nome) {
                                                if (isset($nome['nivel_de_acesso'])&& in_array($_SESSION['admin_nivel_acesso'], $nome['nivel_de_acesso']) ) {
                                                    ...
                                                    if ($nome['type']=='text') {
                                                        ...
                                                        echo '<td class="center">'.implode("/",array_reverse(explode("-", $resultado[$nome['bd']]))).'</td>';
                        ...
                        <?php } ?>
                            ...
                            <div class="<?php echo $campo['class'];?>"<?php echo $attr_data.$attr_style; ?>>
                                <?php if ($campo['input'] == 'text') { ?>
                                    <input type="text" name="<?php echo $campo['name'];?>" id="<?php echo $campo['name'];?>" class="full-width" maxlength="<?php echo $campo['amount'];?>" value="<?=$data[$campo['name']];?>">
                                <?php }
                                if ($campo['input'] == 'cep') { ?>
                                    <input type="cep" name="<?php echo $campo['name'];?>" id="<?php echo $campo['name'];?>" class="full-width" maxlength="<?php echo $campo['amount'];?>" value="<?=$data[$campo['name']];?>">
                                <?php }
                                ...
                                if ($campo['input'] == 'date') { ?>
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input class="form-control input-mask-date date-picker" type="text" id="<?php echo $campo['name'];?>" name="<?php echo $campo['name'];?>" value="<?=$data[$campo['name']];?>" />
                                ...
                                if ($campo['input'] == 'textarea') { ?>
                                    <textarea type="text" class="full-width" rows="<?php echo $campo['parametros']['rows']; ?>" maxlength="<?php echo $campo['amount'];?>" name="<?php echo $campo['name'];?>" id="<?php echo $campo['name'];?>" style="height:200px;"><?= html_entity_decode($data[$campo['name']]) ;?></textarea>
                                <?php }
                                if ($campo['input'] == 'editor') { ?>
                                    <textarea type="text" class="full-width" name="<?php echo $campo['name'];?>" id="<?php echo $campo['name'];?>"><?=$data[$campo['name']];?></textarea>
                                <?php }
                        ...
                        if ($campo['mostrar_campo']) { ?>
                            <div class="row">
                                ...
                                <div class="<?php echo $campo['class'];?>">
                                    <?php if ($campo['input'] == 'text') { ?>
                                        <input type="text" name="<?php echo $galeria['bd'].'_'.$campo['name'];?>" id="<?php echo $galeria['bd'].'_'.$campo['name'];?>" class="full-width" maxlength="<?php echo $campo['amount'];?>" value="<?=$data[$galeria['bd'].'_'.$campo['name']];?>">
                                    <?php }
                                    if ($campo['input'] == 'category') { ?>
                    ...
                    if (isset($campo['parametros'][0]['only'])) { 
                        if (in_array($url[2], $campo['parametros'][0]['only'])) {
                            if ($campo['input']=='dropdown_plus_more_options') {
                                ...
                                print_r($json);
                                echo '<div class="row" id="area_multi_'.$campo['name'].'">'; ?>
                                    <?php foreach ($result_json as $json): ?>
                                        <div class="col-md-3" style="outline: 5px solid #e3e3e3; padding: 25px;">
                                            <div class="text-center"> <label><?php echo $campo['titulo']; ?></label> </div>
                                            <?php foreach ($campo['parametros']['fields'] as $index => $field): ?>
                                                <div style="margin-bottom: 10px;">
                                                    <?php if ($field['type']['input'] == 'image') { ?>
                                                        <?php if (isset($json[$field['name']])) {
                                                            ...
                                                            <div class="input-group full-width text-center">
                                                                Imagem atual<br/>
                                                                <img src="<?php echo $Funcoes->image($imagem,320,220,$real_path,'cortar',100,$src_path); ?>" class="img-responsive" style="display: initial;">
                                                            </div>
                                                        <?php } ?>
                                                        <label>
                                                            <?php echo $field['label'] ?>
                            ...
                            <?php }else{
                                ...
                                <?php } ?>
                                    ...
                                    <div class="<?php echo $campo['class'];?>"<?php echo $attr_data.$attr_style; ?>>
                                        ...
                                        <?php }
                                        if ($campo['input'] == 'int') { ?>
                                            <input type="text" name="<?php echo $campo['name'];?>" id="<?php echo $campo['name'];?>" class="full-width input-mask-int text-center" maxlength="<?php echo $campo['amount'];?>" value="<?=$resultado[$campo['name']];?>">
                                        <?php }
                                        if ($campo['input'] == 'select') { ?>
                                            <select name="<?php echo $campo['name'];?>" id="<?php echo $campo['name'];?>">
                                                <option value=""></option>
    ...
    <?php foreach ($sistema['campos'] as $campo) {
        ...
        if ($input=='dropdown_plus_more_options') { ?>
            ...
            $('button[type="add-more-<?php echo $campo['name']; ?>"]').click(function(event) {
                event.preventDefault();
                $('#area_multi_<?php echo $campo['name']; ?>').append(add_more_<?php echo $campo['name']; ?>);
                mascara_money(); 
